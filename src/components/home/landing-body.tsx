    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 md:px-8">
          <p className="mx-auto max-w-2xl text-center text-sm md:text-base text-[#3b4456] mb-6">
            Aplicativo inspirado no Soccermatics Pro e nos insights obtidos na comunidade de analytics da Twelve FC &amp; Training Ground Guru
          </p>
          <div className="mx-auto max-w-2xl rounded-2xl bg-[#0b1326] shadow-[0_20px_50px_-20px_rgba(11,19,38,0.45)] ring-1 ring-white/5 p-6 md:p-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-5 md:gap-8">
              <h2 className="text-sm md:text-base font-black tracking-tighter text-slate-300 uppercase text-center md:text-left shrink-0">
                SELECIONE SEU CLUBE
              </h2>
